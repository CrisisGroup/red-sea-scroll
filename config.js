var config = {
    ...
    use3dTerrain: false,
    auto: false,
    title: '<h1>Yemen and Beyond: Militarisation in the Red Sea</h1><video id="background-video" autoplay loop muted poster="images/poster.jpg"><source src="images/aerial.mp4" type="video/mp4">',
    subtitle: '',
    start: 'BEGIN',
